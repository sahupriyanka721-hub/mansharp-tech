          ...
          <nav className={`hidden lg:flex items-center gap-8 text-sm font-medium ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
            ...
            <div className="relative group py-2 cursor-pointer">
              ...
              <div className={`absolute top-full left-0 w-48 border rounded-2xl shadow-2xl p-2 flex flex-col gap-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50 ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                ...
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Why Choose Us</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Life At Mansharp</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Leadership</button>
              </div>
            </div>
            ...
            <div className="relative group py-2 cursor-pointer">
              ...
              <div className={`absolute top-full left-0 w-56 border rounded-2xl shadow-2xl p-3 grid grid-cols-2 gap-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50 ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                {['Healthcare', 'Education', 'Public Sector', 'Financial Services', 'Manufacturing', 'Energy', 'Retail', 'Software'].map((ind, idx) => (
                  <button key={idx} onClick={() => setActiveTab('about')} className={`text-left px-2 py-1.5 rounded-lg text-[11px] transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>{ind}</button>
                ))}
              </div>
            </div>
            ...
            <div className="relative group py-2 cursor-pointer">
              ...
              <div className={`absolute top-full left-0 w-48 border rounded-2xl shadow-2xl p-2 flex flex-col gap-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50 ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Blogs</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Case Studies</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Events & Workshops</button>
              </div>
            </div>
            ...
            <div className="relative group py-2 cursor-pointer">
              ...
              <div className={`absolute top-full left-0 w-56 border rounded-2xl shadow-2xl p-2 flex flex-col gap-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50 ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Department Solutions</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Licenses</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Technologies</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3.5 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Integration & Consulting</button>
              </div>
            </div>
            ...
            <div className="relative group py-2 cursor-pointer">
              ...
              <div className={`absolute top-full left-[-40px] w-56 border rounded-2xl shadow-2xl p-2 flex flex-col gap-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 z-50 ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>AIM App</button>
                <button onClick={() => setActiveTab('about')} className={`text-left px-3 py-2 rounded-xl text-xs transition-colors ${isDark ? 'hover:bg-slate-800 text-slate-300' : 'hover:bg-slate-100 text-slate-700'}`}>Mansharp Org Chart</button>
              </div>
            </div>
      ...
      <footer className={`border-t text-xs py-12 px-4 sm:px-8 mt-auto transition-colors duration-300 ${isDark ? 'border-slate-800 bg-slate-900/90 text-slate-400' : 'border-slate-200 bg-white text-slate-600'}`}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-inherit">
          ...
          <div className="space-y-3">
            <p className="flex items-center gap-2 hover:text-blue-500 transition-colors cursor-pointer">
            ...
            <p className="flex items-center gap-2 hover:text-blue-500 transition-colors cursor-pointer">
              <span className="text-blue-500 font-bold">✉️</span> info@pentahara.com
            </p>
          </div>

          <div className="space-y-2">
            <h4 className={`font-bold mb-2 uppercase tracking-wider text-[11px] ${isDark ? 'text-white' : 'text-slate-900'}`}>Licenses</h4>
            <p className="hover:text-blue-500 cursor-pointer">Technologies</p>
            <p className="hover:text-blue-500 cursor-pointer">Integration & Consulting</p>
          </div>

          <div className="space-y-2">
            <h4 className={`font-bold mb-2 uppercase tracking-wider text-[11px] ${isDark ? 'text-white' : 'text-slate-900'}`}>Industries</h4>
            <p className="hover:text-blue-500 cursor-pointer">Healthcare</p>
            <p className="hover:text-blue-500 cursor-pointer">Manufacturing</p>
            <p className="hover:text-blue-500 cursor-pointer">Public Sector</p>
            <p className="hover:text-blue-500 cursor-pointer">View More →</p>
          </div>

          <div className="space-y-2">
            <h4 className={`font-bold mb-2 uppercase tracking-wider text-[11px] ${isDark ? 'text-white' : 'text-slate-900'}`}>Products</h4>
            <p className="hover:text-blue-500 cursor-pointer">Org Chart</p>
            <p className="hover:text-blue-500 cursor-pointer">Asset Management App</p>
            <p className="hover:text-blue-500 cursor-pointer">Expense Management App</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            ...
            <span>•</span>
            <span className="hover:text-blue-500 cursor-pointer">Terms And Conditions</span>
          </div>
        </div>
